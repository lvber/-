        ...
        <div class="page-content">
            <script>
                function getAmount() {
                    var chkObjs = null;
                    var amount = 0;
                    var obj = document.getElementsByName("serviceId")
                    ...
                    <div class="portlet box blue">
                        ...
                        <div class="portlet-body">
                            <form action="search" method="post">
                                ...
                                <input type="hidden" name="method" value="cashier">
                            </form>
                        </div>
                    </div>
                </div>
                                    ...
                                    <tbody>
                                        ...
                                        <tr><td>助理操作员</td>
                                            <td><%
                                                ...
                                                %>
                                                <label><input type="radio" name="staffId2" value="<%=s.getStaffId()%>" ><%=s.getName()%></label>
                                                <%}
                                                        }%></td></tr>
                                        <tr><td>*会员卡卡号</td><td>散客</td></tr>
                                        <tr><td>*消费内容</td>
                                            <td><%ArrayList<Service> services = ServiceManager.retrieveAll();
                                                for (int i = 0; i < services.size(); i++) {
                                                    Service s = services.get(i);
                                                %>
                                                <label><input type="radio" name="serviceId" value="<%=s.getId()%>" onclick="getAmount();" required ><%=s.getDetail()%><%=s.getPrice()%></label>
                                                <input type="hidden" name="<%=s.getId()%>" value="<%=s.getPrice()%>" >
                                                <%if ((i + 1) % 3 == 0) {
                                                            out.println("<br />");
                                                        }
                                                    }
                        ...
                        <form action="add" method="post" name="c">
                            <table class="table table-hover table-bordered">
                                <tbody>
                                    ...
                                    <tr><td>折扣</td><td><input id="2" type="text" name="discount" value="<%=CardManager.retrieveByType(member.getType()).getDiscount()%>" ></td></tr>
                                    <tr><td>*消费内容</td>
                                        <td><%ArrayList<Service> services = ServiceManager.retrieveAll();
                                            for (int i = 0; i < services.size(); i++) {
                                                Service s = services.get(i);
                                            %>
                                            <label><input type="radio" name="serviceId" value="<%=s.getId()%>" onclick="getMemberPrice();" required ><%=s.getDetail()%><%=s.getPrice()%></label>
                                            <input type="hidden" name="<%=s.getId()%>" value="<%=s.getPrice()%>" >
                                            <%if ((i + 1) % 3 == 0) {
                                                        out.println("<br />");
                                                    }
                        ...
                        <form action="add" method="post" name="c">
                            <table class="table table-hover table-bordered">
                                <tbody>
                                    ...
                                    <tr><td>折扣</td><td><input id="2" type="text" name="discount" value="" ></td></tr>
                                    ...
                                    <tr><td>折扣</td><td><input id="2" type="text" name="discount" value="<%=discount%>" ></td></tr>
                                            <%}%>
